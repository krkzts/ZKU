...
describe("CustomTest", function () {
    ...
    it("should deposit ETH in L1 and withdraw ETH in L2", async function () {
        const { merkleTreeWithHistory, tornadoPool, token, omniBridge } = await loadFixture(fixture)
        const aliceKeypair = new Keypair()

        // print gas needed to insert a pair of leaves
        ...
        // deposits into tornado pool in L1
        ...
        // withdraws a part of his funds from the shielded pool in L2
